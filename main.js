...
function AddEvent(el, ev, func) {
    if (!el) {
        console.error('Element not found for AddEvent:', el, ev);
        return false;
    }
    if (el.addEventListener) {
        ...
        var func2 = function() { func.call(el); };
...
Game.Launch=function()
{
	...
	'<div class="listing">'+loc("Cookie Clicker is a javascript game by %1, %2, and rehosted by Andrew.",['<a href="//orteil.dashnet.org" target="_blank">Orteil</a>','<a href="//dashnet.org" target="_blank">Opti</a>'])+'</div>'+
	...
	Game.Init=function()
	{
		...
		if (!App)
		{
			...
			Game.attachTooltip(l('topbarAbout'),'<div style="padding:8px;width:250px;text-align:center;">All credits go to Orteil. <br> All I did (Andrew) was repost it.</div>','this');
